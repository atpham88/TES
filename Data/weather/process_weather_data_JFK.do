...
import delimited using "C:\Users\atpha\Documents\Postdocs\Projects\TES\Data\weather\JFK.csv", clear
rename valid date
...
drop dupindicator
* missing hour 23 in day 2
expand 2 if (date==2 & month==3 & hour==22), gen(dupindicator)
...
*** May:
* Missing hour 1 of days 9,10, 12
...
expand 2 if (date==11 & month==5 & hour==24), gen(dupindicator)
replace hour = 1 if dupindicator == 1
replace date = 12 if dupindicator == 1
drop dupindicator
...
*** Jul:
* missing hour 19 of day 19
expand 2 if (date==19 & month==7 & hour==18), gen(dupindicator)
...
replace hour = 2 if dupindicator == 1
drop dupindicator
* missing hour 20 of day 7
expand 2 if (date==7 & month==8 & hour==19), gen(dupindicator)
...
export delimited using "C:\Users\atpha\Documents\Postdocs\Projects\TES\Data\weather\ext_temp_NY.csv"
