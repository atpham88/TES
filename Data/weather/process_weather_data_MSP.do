...
import delimited using "C:\Users\atpha\Documents\Postdocs\Projects\TES\Data\weather\MSP.csv", clear
rename valid date
...
drop dupindicator
* missing hour 7 of day 7:
expand 2 if (date==7 & month==1 & hour==6), gen(dupindicator)
replace hour = 7 if dupindicator == 1
drop dupindicator
* missing hour 8 of day 7:
expand 2 if (date==7 & month==1 & hour==7), gen(dupindicator)
replace hour = 8 if dupindicator == 1
drop dupindicator
* missing hour 21 of day 7:
expand 2 if (date==7 & month==1 & hour==20), gen(dupindicator)
replace hour = 21 if dupindicator == 1
drop dupindicator
sort year month date hour

*** Feb:
* missing hour 7 of day 20:
expand 2 if (date==20 & month==2 & hour==6), gen(dupindicator)
replace hour = 7 if dupindicator == 1
drop dupindicator
sort year month date hour
...
drop dupindicator
* missing hour 11 of day 3
expand 2 if (date==3 & month==4 & hour==10), gen(dupindicator)
...
replace hour = 3 if dupindicator == 1
drop dupindicator
* missing hour 16 of day 29
expand 2 if (date==29 & month==5 & hour==15), gen(dupindicator)
...
drop dupindicator
* missing hour 21 of day 24
expand 2 if (date==24 & month==5 & hour==20), gen(dupindicator)
replace hour = 21 if dupindicator == 1
drop dupindicator
sort year month date hour
...
*** Sep:
* missing hour 8 of day 8
expand 2 if (date==8 & month==9 & hour==7), gen(dupindicator)
replace hour = 8 if dupindicator == 1
drop dupindicator
* missing hour 9 of day 8
expand 2 if (date==8 & month==9 & hour==8), gen(dupindicator)
...
replace hour = 11 if dupindicator == 1
drop dupindicator
* missing hour 18 of day 10
expand 2 if (date==10 & month==11 & hour==17), gen(dupindicator)
...
expand 2 if (date==10 & month==12 & hour==11), gen(dupindicator)
...
export delimited using "C:\Users\atpha\Documents\Postdocs\Projects\TES\Data\weather\ext_temp_Minneapolis.csv"
