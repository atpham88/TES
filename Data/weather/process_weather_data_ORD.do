...
import delimited using "C:\Users\atpha\Documents\Postdocs\Projects\TES\Data\weather\ORD.csv", clear
rename valid date
...
*** Feb:
* missing hour 12 of day 4:
expand 2 if (date==4 & month==2 & hour==11), gen(dupindicator)
...
replace hour = 3 if dupindicator == 1
drop dupindicator
* missing hour 10 of day 22
expand 2 if (date==22 & month==5 & hour==9), gen(dupindicator)
...
replace hour = 4 if dupindicator == 1
drop dupindicator
* missing hour 8 of day 12
expand 2 if (date==12 & month==6 & hour==7), gen(dupindicator)
...
expand 2 if (date==15 & month==11 & hour==9), gen(dupindicator)
replace hour = 10 if dupindicator == 1
drop dupindicator
...
*** Dec:
* missing hour 1 of day 14
expand 2 if (date==13 & month==12 & hour==24), gen(dupindicator)
replace hour = 1 if dupindicator == 1
replace date = 14 if dupindicator == 1
drop dupindicator
* missing hour 6 of day 3
expand 2 if (date==3 & month==12 & hour==5), gen(dupindicator)
replace hour = 6 if dupindicator == 1
drop dupindicator
* missing hour 8 of day 2
expand 2 if (date==2 & month==12 & hour==7), gen(dupindicator)
replace hour = 8 if dupindicator == 1
drop dupindicator
sort year month date hour
...
export delimited using "C:\Users\atpha\Documents\Postdocs\Projects\TES\Data\weather\ext_temp_Chicago.csv", replace
