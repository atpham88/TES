...
import delimited using "C:\Users\atpha\Documents\Postdocs\Projects\TES\Data\weather\MCO.csv", clear
rename valid date
...
expand 2 if (date==9 & month==8 & hour==16), gen(dupindicator)
...
drop dupindicator
* missing hour 23 of day 15
expand 2 if (date==15 & month==11 & hour==22), gen(dupindicator)
...
export delimited using "C:\Users\atpha\Documents\Postdocs\Projects\TES\Data\weather\ext_temp_Orlando.csv"
