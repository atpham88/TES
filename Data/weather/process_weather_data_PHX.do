...
import delimited using "C:\Users\atpha\Documents\Postdocs\Projects\TES\Data\weather\PHX.csv", clear
rename valid date
...
*** Jul:
* missing hour 20 of day 9
expand 2 if (date==9 & month==7 & hour==19), gen(dupindicator)
...
expand 2 if (date==11 & month==8 & hour==1), gen(dupindicator)
replace hour = 2 if dupindicator == 1
drop dupindicator
...
replace hour = 2 if dupindicator == 1
drop dupindicator
* missing hour 6 of day 4
expand 2 if (date==4 & month==8 & hour==5), gen(dupindicator)
replace hour = 6 if dupindicator == 1
drop dupindicator
* missing hour 7 of day 4
expand 2 if (date==4 & month==8 & hour==6), gen(dupindicator)
...
expand 2 if (date==4 & month==8 & hour==13), gen(dupindicator)
...
drop dupindicator
* missing hour 13 of day 26
expand 2 if (date==26 & month==10 & hour==12), gen(dupindicator)
...
export delimited using "C:\Users\atpha\Documents\Postdocs\Projects\TES\Data\weather\ext_temp_Phoenix.csv"
